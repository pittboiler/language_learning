// MACHINE-GENERATED (Opus 4.8) for curriculum stage 1. confidence:"unreviewed" — GATED, NOT imported by index.ts / served until a native spot-check promotes it.
// 41 vocab · 4 scenarios · 4 mini-stories · 2 grammar · 3 readers · 3 writing · 3 info-gap. Validator flagged 13 line(s) — see pipeline/output/wave-mk-stage1.md.
...
export const generatedScenarios: Scenario[] = [
  ...
  },
  {
    ...
    "script": [
      ...
      {
        "speaker": "learner",
        "text": "Јас сум учителка. Една кафа, ве молам.",
        "gloss": "I am a teacher. One coffee, please.",
        "translit": "Yas sum uchitelka. Edna kafa, ve molam.",
        "satisfies": [
          "stated-occupation"
        ]
      }
  ...
  },
  {
    ...
    "goal": "Practise these functions: ask-the-way, understand-directions, name-transport. Use the taught chunks where natural: Каде е …?; лево; десно; направо; близу / далеку; тука / таму. Recycle earlier material: s0-survive, s0-repair, s1-cafe-order.",
...
export const generatedStories: MiniStory[] = [
  ...
  },
  {
    ...
    "body": [
      ...
      },
      {
        ...
        "translit": "„Da, imame. Sakam edno kilo yabolka.“",
  ...
  },
  {
    ...
    "body": [
      ...
      {
        "text": "„Потоа одете направо. Тоа е близу.“",
      ...
      {
        "text": "Таму има автобус во центар.",
...
export const generatedGrammar: GrammarConcept[] = [
  {
    "id": "gender",
...
export const generatedReaders: Reader[] = [
  {
  ...
  },
  {
    ...
    "body": [
      ...
      {
        "speaker": "partner",
        "text": "Таа оди десно и патува во центар.",
...
export const generatedWritingTasks: WritingTask[] = [
  {
...
export const generatedInfoGapTasks: InfoGapTask[] = [
  {
    ...
    "roleA": {
      ...
      "targetPhrases": [
        {
          "text": "Добар вечер! Едно пиво и еден сок, ве молам.",
    ...
    "roleB": {
      ...
      "targetPhrases": [
        {
          "text": "Добар вечер! Повелете, што сакате?",
  ...
  },
  {
    ...
    "roleB": {
      ...
      "targetPhrases": [
        {
          "text": "Одете направо, потоа лево.",
          "gloss": "Go straight, then left.",
          "translit": "Odete napravo, potoa levo."
        },
        {
...
export const validatorReport = [
  {
    "itemId": "gen-s1-cafe-order-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v9",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-v10",
    "ok": false,
    "issues": [
      "Spelling: should be written as two words 'На здравје!' not 'Наздравје!'"
    ],
    "corrected": "На здравје!"
  },
  {
    "itemId": "gen-s1-cafe-order-v11",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-l3",
    "ok": false,
    "issues": [
      "The two sentences belong to different speakers: 'Повелете' (here you are/go ahead) is typically said by the waiter offering something, while 'Сметката, ве молам' (the bill, please) is said by the customer. Combined as one utterance it's contradictory/unnatural."
    ],
    "corrected": "Сметката, ве молам."
  },
  {
    "itemId": "gen-s1-cafe-order-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-story-s1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-story-s2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-story-s3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-story-s4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-story-s6",
    "ok": false,
    "issues": [
      "The toast is standardly written as two words: „На здравје!“ rather than „Наздравје!“"
    ],
    "corrected": "„На здравје!“ вели Марко."
  },
  {
    "itemId": "gen-s1-cafe-order-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-story-s8",
    "ok": true,
    "issues": []
  },
  {
  ...
  {
    "itemId": "gen-s1-cafe-order-gender-d1",
    "ok": false,
    "issues": [
      "The gloss 'one coffee' does not match the word 'едно' alone, which means just 'one'. 'кафе' is part of the context, not the target word."
    ],
    "corrected": "едно — one (neuter)"
  },
  {
    "itemId": "gen-s1-cafe-order-gender-d2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-gender-d3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "definite-articles-ex1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "definite-articles-ex2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "definite-articles-ex3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-definite-articles-d1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-definite-articles-d2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-definite-articles-d3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-reader-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-reader-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-reader-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-reader-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-reader-l5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-reader-l6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-gap-A1",
    "ok": false,
    "issues": [
      "'Добар вечер' has wrong gender agreement — 'вечер' is feminine in Macedonian, so it should be 'Добра вечер' (or 'Добровечер')."
    ],
    "corrected": "Добра вечер! Едно пиво и еден сок, ве молам."
  },
  {
    "itemId": "gen-s1-cafe-order-gap-A2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-gap-A3",
    "ok": false,
    "issues": [
      "English gloss has a number agreement error: 'five hundred denars' is plural, so it should be 'Here are five hundred denars.'"
    ],
    "corrected": "Еве петстотини денари. — Here are five hundred denars."
  },
  {
    "itemId": "gen-s1-cafe-order-gap-A4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-gap-B1",
    "ok": false,
    "issues": [
      "'Добар вечер' is incorrect in standard Macedonian — 'вечер' is feminine and the fixed greeting is 'Добровечер' (one word). 'Добар вечер' is a calque from Bulgarian/Serbian.",
      "Missing capital handling aside, the rest ('Повелете, што сакате?') is correct and natural."
    ],
    "corrected": "Добровечер! Повелете, што сакате?"
  },
  {
    "itemId": "gen-s1-cafe-order-gap-B2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-gap-B3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-cafe-order-gap-B4",
    "ok": false,
    "issues": [
      "'на здравје' literally means 'to your health' (used as a toast, after a sneeze 'bless you', or when offering food/drink) — it is not natural when handing back change",
      "The English gloss 'cheers' doesn't accurately match 'на здравје' in this context; pairing change with 'на здравје' sounds odd to a native speaker",
      "More natural would be 'Повелете' (here you go) or 'Пријатно' when giving change"
    ],
    "corrected": "Еве кусур, повелете!"
  },
  {
    "itemId": "gen-s1-greet-intro-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-v4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-v6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-v9",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-story-s1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-story-s2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-story-s3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-story-s4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-story-s6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-greet-intro-story-s8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v9",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-v10",
    "ok": false,
    "issues": [
      "'фала' is a colloquial/spoken form; for beginner learning content the standard form 'благодарам' is preferable.",
      "'Само тоа' is understandable but slightly clipped; 'Само тоа е сѐ' or 'Тоа е сѐ' is more natural for 'That's all'."
    ],
    "corrected": "Тоа е сѐ, благодарам."
  },
  {
    "itemId": "gen-s1-market-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-story-s1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-story-s2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-story-s3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-story-s4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-story-s6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-story-s8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-reader-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-reader-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-reader-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-reader-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-reader-l5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-reader-l6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-gap-A1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-gap-A2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-gap-A3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-gap-B1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-gap-B2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-market-gap-B3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v4",
    "ok": false,
    "issues": [
      "'направо' is not standard Macedonian; it is a Serbian/Russian form. The Macedonian word for 'straight ahead' is 'право' (or 'право напред')."
    ],
    "corrected": "право"
  },
  {
    "itemId": "gen-s1-directions-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v9",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-v10",
    "ok": false,
    "issues": [
      "'во центар' literally means 'in centre' (location), not 'to the centre' (direction) — gloss mismatch",
      "Missing definite article; natural Macedonian would be 'во центарот' (in/to the centre)",
      "As written, 'во центар' sounds incomplete/unnatural for a beginner phrase"
    ],
    "corrected": "во центарот — in/to the centre"
  },
  {
    "itemId": "gen-s1-directions-v11",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-story-s1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-story-s2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-story-s3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-story-s4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-story-s6",
    "ok": false,
    "issues": [
      "'во центар' means 'in the centre', not 'to the centre' — the gloss doesn't match; a bus going to a destination uses 'за' or 'до'.",
      "'центар' should be definite ('центарот') to mean 'the centre'.",
      "The phrasing 'автобус во центар' is unnatural in Macedonian."
    ],
    "corrected": "Таму има автобус за центарот."
  },
  {
    "itemId": "gen-s1-directions-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-story-s8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-reader-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-reader-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-reader-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-reader-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-reader-l5",
    "ok": false,
    "issues": [
      "Semantically odd: taxis don't use tickets (билет), so 'билет за такси' is unnatural. A native speaker wouldn't say this. Use 'билет за воз/автобус' or 'пари за такси'."
    ],
    "corrected": "Ана нема билет за воз."
  },
  {
    "itemId": "gen-s1-directions-reader-l6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-gap-A1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-gap-A2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-gap-A3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-gap-B1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-gap-B2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s1-directions-gap-B3",
    "ok": true,
    "issues": []
  }
] as const;
