// MACHINE-GENERATED (Opus 4.8) for curriculum stage 2. confidence:"unreviewed" — GATED, NOT imported by index.ts / served until a native spot-check promotes it.
// 42 vocab · 5 scenarios · 5 mini-stories · 0 grammar · 0 readers · 9 writing · 2 info-gap. Validator flagged 13 line(s) — see pipeline/output/wave-mk-stage2.md.
...
export const generatedScenarios: Scenario[] = [
  ...
  },
  {
    ...
    "script": [
      ...
      {
        "speaker": "learner",
        "text": "Отидов во кафе и јадев сендвич.",
  ...
  },
  {
    ...
    "script": [
      ...
      {
        "speaker": "learner",
        "text": "Ајде во кафето на плоштадот.",
...
export const generatedStories: MiniStory[] = [
  ...
  },
  {
    ...
    "body": [
      ...
      {
        "text": "„Бев во парк и читав книга“, вели Марко.",
    ...
    "qa": [
      {
        "id": "q1",
        "question": "Каде отидов Марко денес?",
      ...
      {
        "id": "q2",
        "question": "Што јадев Марко во парк?",
  ...
  },
  {
    ...
    "body": [
      ...
      },
      {
        ...
        "translit": "Moyot tatko e dobar maž.",
...
export const validatorReport = [
  {
    "itemId": "gen-s2-smalltalk-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-v4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-v6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-v9",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-smalltalk-story-s9",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-v4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-v6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-l2",
    "ok": false,
    "issues": [
      "'кафе' usually means 'coffee'; for 'café' a native speaker would say 'кафуле' (or 'кафана')",
      "aspect: 'јадев' is imperfective ('was eating'); for a completed action 'изедов сендвич' is more natural"
    ],
    "corrected": "Отидов во кафуле и изедов сендвич."
  },
  {
    "itemId": "gen-s2-pasttime-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-story-s1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-story-s2",
    "ok": false,
    "issues": [
      "Verb conjugation error: 'имав' is 1st person singular (I had), but subject 'Тој' (he) requires 3rd person singular 'имаше'."
    ],
    "corrected": "Тој имаше многу работа."
  },
  {
    "itemId": "gen-s2-pasttime-story-s3",
    "ok": false,
    "issues": [
      "Wrong verb conjugation: 'отидов' is 1st person singular (I went), but subject is Marko (3rd person), should be 'отиде'",
      "Missing definite article: 'во парк' should be 'во паркот' to match 'the park'"
    ],
    "corrected": "Денес Марко отиде во паркот."
  },
  {
    "itemId": "gen-s2-pasttime-story-s4",
    "ok": false,
    "issues": [
      "Verb form mismatch: 'јадев' is first person singular ('I ate'), but the gloss says 'he ate' (which would be 'јадеше')."
    ],
    "corrected": "Таму јадев сендвич. (There I ate a sandwich.)"
  },
  {
    "itemId": "gen-s2-pasttime-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-story-s6",
    "ok": false,
    "issues": [
      "'во парк' sounds incomplete/unnatural without the definite article; the gloss says 'the park', which corresponds to 'паркот'.",
      "'читав книга' is grammatically fine but slightly more natural as 'читав книга' or 'читав една книга'; minor."
    ],
    "corrected": "„Бев во паркот и читав книга“, вели Марко."
  },
  {
    "itemId": "gen-s2-pasttime-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-pasttime-story-s8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-v9",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-home-family-story-s9",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-v4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-v6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-l3",
    "ok": false,
    "issues": [
      "The gloss says 'Let's meet' but the Macedonian contains no verb for 'meet' — it implies 'let's go' (Ајде = come on/let's go).",
      "'кафето' most naturally means 'the coffee'; for 'cafe' the natural word is 'кафулето' (or 'кафето' is ambiguous).",
      "The sentence is elliptical/casual and doesn't clearly express the intended meaning."
    ],
    "corrected": "Ајде да се сретнеме во кафулето на плоштадот."
  },
  {
    "itemId": "gen-s2-arrange-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-story-s1",
    "ok": false,
    "issues": [
      "Missing dative clitic 'ѝ' — Macedonian requires clitic doubling: 'Марко ѝ телефонира на Ана.'",
      "More natural verb would be 'се јавува' (to call)."
    ],
    "corrected": "Марко ѝ телефонира на Ана."
  },
  {
    "itemId": "gen-s2-arrange-story-s2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-story-s3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-story-s4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-story-s6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-story-s8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-gap-A1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-gap-A2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-gap-A3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-gap-B1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-gap-B2",
    "ok": false,
    "issues": [
      "The gloss omits the preposition: 'Во седум часот' means 'At seven o'clock', not 'Seven o'clock'.",
      "The sentence order is unnatural — saying the time is good, then asking 'When? Tomorrow?' reads disjointed for a beginner phrase."
    ],
    "corrected": "Во седум часот е добро. — At seven o'clock is good."
  },
  {
    "itemId": "gen-s2-arrange-gap-B3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-arrange-gap-B4",
    "ok": false,
    "issues": [
      "'Тоа е десно' is unnatural; a native speaker would say 'Тоа е надесно' or 'Тоа е од десната страна' to mean 'it's on the right'."
    ],
    "corrected": "Тоа е надесно, до банката."
  },
  {
    "itemId": "gen-s2-problems-v1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-v2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-v3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-v4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-v5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-v6",
    "ok": false,
    "issues": [
      "The Macedonian lacks an object, so 'Сакам да вратам' sounds incomplete/unnatural — a native speaker would include the clitic/object.",
      "The gloss says 'return (this)' but the Macedonian has no word for 'this' or 'it'."
    ],
    "corrected": "Сакам да го вратам ова."
  },
  {
    "itemId": "gen-s2-problems-v7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-v8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-l1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-l2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-l3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-l4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-story-s1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-story-s2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-story-s3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-story-s4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-story-s5",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-story-s6",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-story-s7",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-story-s8",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-gap-A1",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-gap-A2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-gap-A3",
    "ok": false,
    "issues": [
      "The gloss says 'the coffee' (definite) but Macedonian 'кафе' lacks the definite article; should be 'кафето' to match.",
      "'Можете ли да помогнете?' sounds incomplete; a native speaker would add 'ми' (me): 'Можете ли да ми помогнете?'",
      "Returning 'coffee' is a slightly unusual scenario for a beginner phrase."
    ],
    "corrected": "Сакам да го вратам кафето. Можете ли да ми помогнете?"
  },
  {
    "itemId": "gen-s2-problems-gap-A4",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-gap-B1",
    "ok": false,
    "issues": [
      "'Што има проблем?' is unnatural/incorrect Macedonian — a calque. The natural phrasing is 'Каков е проблемот?' or 'Што е проблемот?'",
      "The two sentences ('What's the problem?' and 'Sorry') are oddly combined and don't flow naturally together."
    ],
    "corrected": "Каков е проблемот? Извинете."
  },
  {
    "itemId": "gen-s2-problems-gap-B2",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-gap-B3",
    "ok": true,
    "issues": []
  },
  {
    "itemId": "gen-s2-problems-gap-B4",
    "ok": false,
    "issues": [
      "Number agreement: with plural '40 денари' the verb should be plural 'се', not singular 'е' — 'Вкупно се 40 денари' (or simply 'Вкупно 40 денари')."
    ],
    "corrected": "Вкупно се 40 денари. Во ред?"
  }
] as const;
